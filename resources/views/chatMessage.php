...
<body id="myPage">
  ...
  <div id="menu" class="w3-top" style="display: block;">
    <div class="w3-white w3-card">
      ...
      <a href="home" style="font-size: 20px;" class="w3-bar-item w3-button w3-white"><img width="100" src="./Images/logo.png"></a>
      <div style="margin-top: 10px;" class="w3-right w3-hide-medium w3-hide-small w3-animate-right">
        <a href="" style="font-size: 20px;" class=" w3-bar-item w3-button w3-hide-medium w3-hide-small"><b>สัตว์เลี้ยง</b></a>
        <a href="" style="font-size: 20px;" class=" w3-bar-item w3-button w3-hide-medium w3-hide-small"><b>บริจาค</b></a>
        <a href="" style="font-size: 20px;" class="w3-bar-item w3-button w3-hide-medium w3-hide-small"><b>กิจกรรม</b></a>
...
<script>
  ...
  function newMessage() {
    ...
    console.log(message);
    <?php for ($i = 0; $i < 5; $i++) {
      echo " $('<li class=\"replies\"><img src=\"./Images/userPic.png\" alt=\"\" /><p>' + message + '</p></li>').appendTo($('#message2 ul'));";
    } ?>
